# YTO Express Tracking API For Ruby
YTO Express Tracking API and webhook make it easy to integrate YTO Express Tracking function into your own project. Support APIs Client Libraries for ruby

### API key

In order to use this API, you need to generate a YTO Express Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use YTO Express Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [YTO Express Tracking API](https://www.trackingmore.com/yto-tracking.html)  to:

   *   Get YTO Express realtime tracking info of muti-carriers in one integration
   *   Provide YTO Express shipment tracking experience like Amazon
   *   Push YTO Express notifications of package update with webhook
   *   Verify YTO Express delivery exception before it is too late
